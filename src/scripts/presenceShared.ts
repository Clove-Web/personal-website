...
export const CONNECTION_ICON: Record<string, { Ic?: Icon; img?: string }> = {
  ...
  ebay: { img: "https://m.doughmination.gay/img/icons/ebay.png" },
  tiktok: { Ic: Tiktok },
  bungie: { img: "https://m.doughmination.gay/img/icons/bungie.png" },
  playstation: { Ic: Playstation },
  paypal: { Ic: Paypal },
  instagram: { Ic: Instagram },
  xbox: { Ic: Xbox },
  crunchyroll: { img: "https://m.doughmination.gay/img/icons/crunchyroll.png" },
  battlenet: { img: "https://m.doughmination.gay/img/icons/battlenet.png" },
  github: { Ic: Github },
  epicgames: { img: "https://m.doughmination.gay/img/icons/epic.png" },
  riotgames: { img: "https://m.doughmination.gay/img/icons/riot.png" },
  leagueoflegends: { img: "https://m.doughmination.gay/img/icons/league.png" },
  steam: { Ic: Steam },
  roblox: { img: "https://m.doughmination.gay/img/icons/roblox.png" },
  twitter: { Ic: TwitterX },
  bluesky: { Ic: Bluesky },
